...
with open("temp_create_channel.sh", "w", newline='\n') as f:
    f.write(script_content)

subprocess.run(["docker", "cp", "temp_create_channel.sh", "cli:/opt/gopath/src/github.com/hyperledger/fabric/peer/createChannel.sh"])
subprocess.run(["docker", "exec", "cli", "chmod", "+x", "./createChannel.sh"])
subprocess.run(["docker", "exec", "cli", "./createChannel.sh"])
