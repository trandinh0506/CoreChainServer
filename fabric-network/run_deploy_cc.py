...
with open("temp_deploy_cc.sh", "w", newline='\n') as f:
    f.write(script_content)

subprocess.run(["docker", "cp", "temp_deploy_cc.sh", "cli:/opt/gopath/src/github.com/hyperledger/fabric/peer/deployCC.sh"])
subprocess.run(["docker", "exec", "cli", "chmod", "+x", "./deployCC.sh"])
subprocess.run(["docker", "exec", "cli", "./deployCC.sh"])
